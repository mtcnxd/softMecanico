                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                <p class="fw-bolder text-uppercase text-muted pt-1">Listado de egresos del mes</p>
                            ...
                            <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                <p class="fw-bolder text-uppercase text-muted pt-1">Listado de ingresos del mes</p>
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>#</td>
