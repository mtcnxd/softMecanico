                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" name="postalcode" id="postcode" value="{{ $client->postalcode }}">
                            </div>
                            <div class="col-md-4">
                                <label for="address2" class="form-label">Colonia</label>
                                <select id="address2" class="form-select" name="address2" value="{{ $client->address2 }}">
